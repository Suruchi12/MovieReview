...
class TableViewController: UITableViewController, FavoriteCellDelegate{
   
    var results: MovieResults?
    let reviewVC = ReviewController()
    
    var reviewCountTVC: Int = 0
    var RVCMovieId: Int = 0
    ...
    override func viewDidLoad() {
        ...
        //let reviewImage = UIImage(named: "new_message_icon")
        //navigationItem.rightBarButtonItem = UIBarButtonItem(image: reviewImage, style: .plain, target: self, action: #selector(newReview))
        signInCheck()
    ...
    @objc func newReview(){
        ...
        //reviewVC.delegate = self
        let navReview = UINavigationController(rootViewController: reviewVC)
        present(navReview, animated: true, completion: nil)
    ...
    func downloadJSON(completed: @escaping () -> ()){
        ...
        let url = URL(string: "https://api.themoviedb.org/3/movie/popular?api_key=9833efb4636d8626663b18c31ccdc1a9")
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        //let cell = UITableViewCell(style: .subtitle, reuseIdentifier: "cellid") as! MovieFavouriteCell
...
//        cell.detailTextLabel?.text?.append("\(finalRating)/10")
        ...
        if indexPath.row % 2 == 0 {
            ...
            cell.accessoryView?.backgroundColor = hexStringToUIColor(hex: "#EE6868")
            ...
            cell.accessoryView?.backgroundColor =  hexStringToUIColor(hex: "#FF9B9B" )
